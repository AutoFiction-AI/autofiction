...
2e. Comedy, dark comedy, tragicomedy, or comedy-drama: drive the book through escalating comic situations with real human stakes underneath. Humor must arise from character, situation, and voice — not from narrator wink or meta-commentary. Do not "elevate" a comic premise into seriousness out of nervousness. In tragicomedy, let genuine pain and genuine humor coexist in the same scene when the material calls for it; do not force one register to cancel the other. When the premise specifies comedy as the dominant register for a section of the book, assign comic or comic-adjacent texture_modes to those chapters. Character depth, investigation, anxiety, and dread can all live inside a comic texture_mode — do not switch to dramatic texture_modes for chapters that explore character or raise stakes. The tonal register should change only at the transition point the premise specifies, not gradually across the middle of the book.
